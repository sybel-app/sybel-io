...
struct PodcastBadge {
    ...
    uint40 lastWeekListenCount; // Number of listen performed on this token last week
    uint40 currentWeekListenCount; // Number of listen performed on this token this week
